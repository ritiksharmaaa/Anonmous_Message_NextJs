    ...
    <div className="min-h-screen bg-surface-muted py-12 px-4 font-sans transition-colors">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-surface rounded-2xl shadow-sm border border-border-muted p-8 md:p-12 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3">2. User Conduct</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3">4. Termination</h2>
            <p className="text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-3">5. Changes to This Agreement</h2>
            <p className="text-text-secondary leading-relaxed">
